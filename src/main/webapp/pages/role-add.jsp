...
<%--				method="post">--%>
				...
				<div class="box-tools text-center">
					<button type="submit" class="btn bg-maroon"  id="saveRole">保存</button>
	...
	<script>
		$(document).ready(function() {
			...
			$("#saveRole").click(function(){
				// alert($("input[ name='roleName']").val());
				$.post("${pageContext.request.contextPath}/addrole",{"roleName":$("input[ name='roleName']").val(),"roleDesc":$("input[ name='roleDesc']").val()},function(data){
