...
<%--				method="post">--%>
				...
				<input type="hidden" name="roleId" value="${role.id}">
					...
					<table id="dataList"
							...
							<thead>
								<tr>
									...
									<input id="selall"  name="check_box"
                    ...
                    <div  id="roleid"  name="${roleid}">${roleid}</div>
				<!--订单信息/--> <!--工具栏-->
				<div class="box-tools text-center">
					<button type="submit" class="btn bg-maroon "  onclick="addrole_permission()" >保存</button>
...
<%--			</form>--%>
	...
	function addrole_permission(){
			...
			$.ajax({
				url:"${pageContext.request.contextPath}/roleAddPermission",
				data:{"roleid":$roleid,"permissionid":list},
				type:"get",
				traditional:true,
