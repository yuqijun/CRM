...
<%--			<form action="${pageContext.request.contextPath}/add_product"--%>
<%--				method="post">--%>
				<!-- 正文区域 -->
				...
				<div class="box-tools text-center">
					<button type="submit" class="btn bg-maroon saveProduct">保存</button>
	...
	<script>
		$(document).ready(function() {
			$(".saveProduct").click(function(){
				...
				$productStatus=$("select[name='productStatus']").val();
				$productDesc=$("textarea[name='productDesc']").val();
				alert($productNum+"----"+$productName+"----"+$departureTime+"----"+$cityName+"----"+$productPrice+"----"+$productStatus+"----"+$productDesc);
				$.post("${pageContext.request.contextPath}/add_product",{"productNum":$productNum,"productName":$productName,"departureTime":$departureTime,"cityName":$cityName,"productPrice":$productPrice,"productStatus":$productStatus,"productDesc":$productDesc},function(data){
