...
<%--				method="post">--%>
				...
				<div class="box-tools text-center">
					<button type="submit" class="btn bg-maroon"  id="savePermission">保存</button>
	...
	<script>
		$(document).ready(function() {
			$("#savePermission").click(function(){
				//获取name,url
				// alert($("input[name='permissionName']").val());
				// alert($("input[name='url']").val());
				$.post("${pageContext.request.contextPath}/addPermission",{"permissionName":$("input[name='permissionName']").val(),"url":$("input[name='url']").val()},function(data){
