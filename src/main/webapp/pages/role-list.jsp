...
<%--								</tbody>--%>
		...
		<script>
			...
			$(document).ready(function(){
				$.get("${pageContext.request.contextPath}/showAllRole",function(data){
					//得到所有角色信息
					for(var i = 0; i<data.length;i++){
						 $table1=$("#dataList");
						 $tbody1 = $("<tbody></tbody>");
						 $tr1=$("<tr></tr>");
						 $td1=$("<td><input name=\"ids\" type=\"checkbox\"></td>");
						 $td2=$("<td>"+data[i].id+"</td>");
						 $td3=$("<td>"+data[i].roleName+"</td>");
						 $td4=$("<td>"+data[i].roleDesc+"</td>");
						 $a1=$("<a href=\"javascrpit:void(0)\"     onclick='deleteRoleById("+ data[i].id+")' class=\"btn bg-olive btn-xs\">删除角色</a>");
						 $a2=$("<a href=\"${pageContext.request.contextPath}/showAllPermission1?id="+data[i].id+"\" class=\"btn bg-olive btn-xs\">添加权限</a>");
						 $td5=$("<td class=\"text-center\"></td>");
						$td5.append($a1).append($a2);
			...
			$(document).ready(function() {
				$(".refresh").click(function(){
					window.location.href="${pageContext.request.contextPath}/pages/role-list.jsp";
				});
				// 选择框
				$(".select2").select2();
			...
			function deleteRoleById(id){
				// alert("点击了删除按钮");
				$.get("${pageContext.request.contextPath}/deleteRoleById",{"id":id},function(data){
